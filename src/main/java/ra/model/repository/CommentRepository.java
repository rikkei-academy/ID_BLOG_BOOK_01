...
public interface CommentRepository extends JpaRepository<Comment,Integer> {
    @Query(value = "WITH recursive TEMPDATA(commentId,content,commentStatus,bookId,userId,commentParentId)\n" +
            ...
            "                           union all\n" +
            "                           select child.commentId,child.content,child.commentStatus,child.bookId,child.userId,child.commentParentId\n" +
            "                           from TEMPDATA p\n" +
